...
static void	render_mandelbrot_line(int y, t_env *env, char *data, int size_line,
		int bpp)
{
	t_point	p;
	int		color;
...
static void	render_mandelbrot_lines(t_env *env, char *data, int size_line,
		int bpp)
{
	int	y;
...
static void	render_julia_line(int y, t_env *env, t_julia *julia, char *data,
...
static void	render_julia_lines(t_env *env, t_julia *julia, char *data,
		int size_line, int bpp)
{
	int	y;
...
static void	render_burning_ship_line(int y, t_env *env, char *data,
		int size_line, int bpp)
{
	t_point	p;
	int		color;
...
static void	render_burning_ship_lines(t_env *env, char *data, int size_line,
		int bpp)
{
	int	y;
